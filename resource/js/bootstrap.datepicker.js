...
!function ($) {
  ...
  * ========================= */
  ...
  ,formatSqlDate: function(year,month,day){
    month += 1
    month = new String(month)
    day = new String(day)
  ...
  , select: function (e) {
    ...
    /*icang:tambah formatSqlDate menggunakan data-date untuk kembalian ke mysql*/
    
    $parent.attr('sql-date',$datePicker.formatSqlDate(year,month,day));
