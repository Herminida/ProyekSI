<div class="span9">
    <ul class="nav nav-tabs" id="tab-link">
        <li class="active"><a href="#" onclick="return false">Cetak Kartu Pengobatan Pasien TB</a></li>
    </ul>
...
$(function(){
    ...
    $('#btnTampilkan').click(function(){
        $('#preview').load('<?php echo site_url('poli/'.'tb/laporan_kpp/preview_')?>/'+$('#no_rm_tb').val(),function(response,status,xhr){
        ...
        $('#btnPrint').attr('href','<?php echo site_url('poli/'.'tb/laporan_kpp/print_')?>/'+$('#no_rm_tb').val());
        $('#btnExcel').attr('href','<?php echo site_url('poli/'.'tb/laporan_kpp/excel_')?>/'+$('#no_rm_tb').val());
    });
});
