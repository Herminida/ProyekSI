<div class="span9">
    <ul class="nav nav-tabs" id="tab-link">
        <li class="active"><a href="#" onclick="return false">Cetak Formulir Hasil Akhir Pengobatan Pasien Pindahan</a></li>
    </ul>
...
$(function(){
    ...
    $('#btnTampilkan').click(function(){
        $('#preview').load('<?php echo site_url('poli/'.'tb/laporan_hasil/preview_')?>/'+$('#no_rm_tb').val(),function(response,status,xhr){
        ...
        $('#btnPrint').attr('href','<?php echo site_url('poli/'.'tb/laporan_hasil/print_')?>/'+$('#no_rm_tb').val());
        $('#btnExcel').attr('href','<?php echo site_url('poli/'.'tb/laporan_hasil/excel_')?>/'+$('#no_rm_tb').val());
    });
});
