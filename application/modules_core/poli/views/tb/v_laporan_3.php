<div class="span9">
    <ul class="nav nav-tabs" id="tab-link">
        <li class="active"><a href="#" onclick="return false">3. Daftar Tersangka Pasien (Suspek) TB yang Diperiksa Dahak SPS</a></li>
    </ul>
...
$(function(){
    $('#btnTampilkan').click(function(){
        $('#preview').load('<?php echo site_url('poli/'.'tb/laporan_3/preview_')?>/'+$('#tgl_awal').val()+'/'+$('#tgl_akhir').val(),function(response,status,xhr){
        ...
        $('#btnPrint').attr('href','<?php echo site_url('poli/'.'tb/laporan_3/print_')?>/'+$('#tgl_awal').val()+'/'+$('#tgl_akhir').val());
        $('#btnExcel').attr('href','<?php echo site_url('poli/'.'tb/laporan_3/excel_')?>/'+$('#tgl_awal').val()+'/'+$('#tgl_akhir').val());
    });
    $('#btnPrint').hide();
