<div class="span9">
    <ul class="nav nav-tabs" id="tab-link">
        <li class="active"><a href="#" onclick="return false">Cetak Kartu Identitas Pasien TB</a></li>
    </ul>
...
$(function(){
    ...
    $('#btnTampilkan').click(function(){
        $('#preview').load('<?php echo site_url('poli/'.'tb/laporan_kip/preview_')?>/'+$('#no_rm_tb').val(),function(response,status,xhr){
        ...
        $('#btnPrint').attr('href','<?php echo site_url('poli/'.'tb/laporan_kip/print_')?>/'+$('#no_rm_tb').val());
        $('#btnExcel').attr('href','<?php echo site_url('poli/'.'tb/laporan_kip/excel_')?>/'+$('#no_rm_tb').val());
    });
});
