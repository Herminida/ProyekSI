    <div class="span9"> <!-- content span -->
      <input type="hidden" id="id_poli" name="id_poli" value='4'>
      <ul class="nav nav-tabs" id="tab-link">
    <li class="active"><a href="#" onclick="return false">Gizi</a></li>
...
function getSisaAntrian(){
      $.ajax({
            url: '<?php echo site_url('poli/poligizi/ajaxsisaantrian')?>',
           // data: data,
            method:'post',
            dataType: 'json',
...
$(function(){
  jQuery(document).ready(function(){
    ...
    var purl = '<?php echo site_url("poli/poligizi/ajaxpemeriksaan");?>'+'/'+sData.idpemeriksaan;
