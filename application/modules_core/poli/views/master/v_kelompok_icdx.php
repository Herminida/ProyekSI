 ...
 <!--/span9-->
   ...
   function hapus(){
    ...
    data={ id_kelompok:kelicdData.kode_kelompok};
     $.ajax({
            url: "<?php echo site_url('poli/'.'master/icdx/hapuskelompok')?>",
            data: data,
            method:'post',
            dataType: 'json',
...
kelicdData='';
  ...
  jQuery(document).ready(function(){
      ...
      "bScrollCollapse": false, 
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo site_url('poli/'.'master/icdx/getListKelompok')?>",
        "aoColumns": [
              { "mData": "kode_kelompok" },
              { "mData": "nama_kelompok" }
        ]
      ...
      $('#frmKelompokIcdx').submit(function(){
        ...
        if(err){
          ...
          $.ajax({
            url: '<?php echo site_url('poli/'.'master/icdx/simpankelompok')?>',
            data: data,
            method:'post',
            dataType: 'json',
            success: function(obj){
