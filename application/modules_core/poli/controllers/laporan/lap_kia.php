...
class Lap_KIA extends CI_Controller {
...
public function getLaporanRekamExcel($poli,$judul,$unker,$tgl_awal,$tgl_akhir){
		$query['data']= $this->m_lappasien->getPendaftarPoli($poli,$unker,$tgl_awal,$tgl_akhir);
	...
	public function getLaporanRekam($stat=null){
		$success = '';
		$query['data']= $this->m_lappasien->getPendaftarPoli($this->input->post('poli'),$this->input->post('unker'),$this->input->post('tgl_awal'),$this->input->post('tgl_akhir'));
