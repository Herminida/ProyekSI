...
function __construct(){
	...
	{	$this->view['namapoli'] = 'polilansia';
		$this->template->load('templatePoli','poliklinik/v_polilansia',$this->view);
	...
	public function antrian(){
		$this->view['source'] = 'polilansia/ajaxantrianawal';
	...
	public function ajaxantrianawal(){
		...
		echo $this->m_pasien->get_antrianPasien(null,null,null,10,null,null,null,null);
	}

	public function ajaxSisaAntrian(){
		$data='';
		$data = $this->m_pasien->get_sisaAntrian(10);
		if (!empty($data)){
