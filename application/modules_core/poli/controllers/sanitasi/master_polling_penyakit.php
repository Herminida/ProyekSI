...
class master_polling_penyakit extends CI_Controller {

    function __construct(){
        parent::__construct();
        $this->load->model('master/ms_penyakit');
        //$this->load->model('master/ms_polling_penyakit');
    }

    function index(){
        $this->template->load('templateSanitasi','sanitasi/v_master_polling_penyakit');
    }
