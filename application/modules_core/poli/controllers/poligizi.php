...
function __construct(){
	...
	{	$this->view['namapoli'] = 'poligizi';
		$this->template->load('templatePoli','poliklinik/v_poligizi',$this->view);
	...
	public function ajaxantrianawal(){
		...
		echo $this->m_pasien->get_antrianPasien(null,null,null,4,null,null,null,null);
	}

	public function ajaxSisaAntrian(){
		$data='';
		$data = $this->m_pasien->get_sisaAntrian(4);
		if (!empty($data)){
