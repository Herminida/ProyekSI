...
function __construct(){
	parent::__construct();
	$this->load->model('master/mm_icdx');
}
	public function index(){
		$this->template->load('templatePoli','master/v_icdx');
	}

	public function kelompok()
	{	
		$this->template->load('templatePoli','master/v_kelompok_icdx');

	}

	public function subkelompok()
	{	
		$this->template->load('templatePoli','master/v_subkelompok_icdx');
