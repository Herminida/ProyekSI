<?php
class mtb_pegawai extends CI_Model {
    ...
    function list_data($count=false) {
        ...
        switch ($this->input->post('iSortCol_0')) {
            ...
            case '3': $this->db->order_by('pangkat',$dir); break;
            case '4': $this->db->order_by('nama_unit_kerja',$dir); break;
