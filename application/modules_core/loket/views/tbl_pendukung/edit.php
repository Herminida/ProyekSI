        ...
        <title></title>
            ...
            $(document).ready(function(){
                ...
                $("#update").live('click',function(){
                    ...
                    var id_pendukung = $("#id_pendukung").val();
                    ...
                    $.ajax({
                            type:"POST",
                            url :"<?php echo base_url();?>loket/tbl_pendukung/edit",
                            data:"id_pendukung="+id_pendukung+"&nama_pendukung="+nama_pendukung,
...
<div id="real">
  <div id="statusdonor">
    ...
    <table class="table table-striped">
            ...
            <tr>
                <td ><b>::. EDIT DATA MASTER PENDUKUNG</b></td>
        ...
        <table class="table table-striped">
        	<tbody>
        		...
        		<tr>
        			...
        			<td>:</td>
        			<td>
                        <input type="text" name="nama_pendukung" id="nama_pendukung" value="<?php echo $nama_pendukung ?>"> 
                    </td>
                     <td>&nbsp;</td>
        		</tr>

            <input type="hidden" name="id_pendukung" id="id_pendukung" value="<?php echo $id_pendukung ?>" >
