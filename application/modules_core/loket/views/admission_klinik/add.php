        ...
        <title></title>
            ...
            $(document).ready(function(){
                ...
                $("#simpan").live('click',function(){
                    ...
                    $.ajax({
                            type:"POST",
                            url :"<?php echo base_url();?>loket/admission_klinik/add",
                            data:"nama_klinik="+nama_klinik,
...
<div id="real">
  <div id="statusdonor">
    ...
    <table class="table table-striped">
            ...
            <tr>
                <td ><b>::. TAMBAH DATA MASTER UNIT LAYANAN</b></td>
        ...
        <table class="table table-striped">
        	<tbody>
        		...
        		<tr>
        			...
        			<td>:</td>
        			<td>
                        <input type="text" name="nama_klinik" id="nama_klinik"> 
                    </td>
                     <td>&nbsp;</td>
        		</tr>
