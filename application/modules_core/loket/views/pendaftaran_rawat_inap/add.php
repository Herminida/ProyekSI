                ...
                $(document).ready(function(){
                    $("#kelas_kamar").change(function(){
                         var id_kelas_kamar = $("#kelas_kamar").val();
                            $.ajax({
                                type : "POST",
                                url  : "<?php echo base_url(); ?>loket/pendaftaran_rawat_inap/GetRuangkamar",
                   ...
                   $("#tglregistrasi2").val(tglregistrasi);
                    ...
                    $("#btn-cari").click(function(){
                        ...
                        if(kata_kunci==""){
                            ...
                            $.ajax({
                            type:"POST",
                            url:"<?php echo base_url();?>loket/pendaftaran_rawat_inap/cari_pasien",
...
<div id="real">
  <div id="statusdonor">
    <?php echo form_open('loket/pendaftaran_rawat_inap/add','id="formsimpan"','class="form-horizontal"'); ?>
