...
<hr>
    ...
    ?>
<form class="form-inline" id="frm_cari" style="float:right;" action="<?php echo base_url()?>loket/pendaftaran_pasien_internal/search" method="post">
