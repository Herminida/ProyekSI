        ...
        <title></title>
            ...
            $(document).ready(function(){
               ...
               $("#update").live("click",function(){
                     ...
                     var id_pasien_kebidanan = $("#id_pasien_kebidanan").val();
                     ...
                     $.ajax({
                            type:"POST",
                            url :"<?php echo base_url();?>loket/list_pasien_kebidanan/update",
                            data:"id_pasien_kebidanan="+id_pasien_kebidanan+"&nama_penanggung_jawab="+nama_penanggung_jawab+"&no_penanggung_jawab="+no_penanggung_jawab+"&hubungan_dengan_pasien="+hubungan_dengan_pasien,
...
<div id="real">
  <div id="statusdonor">
    ...
    <table class="table table-striped">
            ...
            <tr>
                <td width="90%"><b>::. EDIT DATA PASIEN KEBIDANAN</b></td>
        ...
        <table class="table table-striped">
        	<tbody>
                ...
                <input type="hidden" name="id_pasien_kebidanan" id="id_pasien_kebidanan" value="<?php echo $id_pasien_kebidanan?>">
