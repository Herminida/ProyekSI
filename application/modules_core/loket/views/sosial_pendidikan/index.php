<div id="real">
	<div id="statusdonor">
		...
		<table class="table">
			<?php echo form_open('loket/sosial_pendidikan/search','class="navbar-form pull-right" ');?>
			<tr>
				<td width="57%"><a class ="btn btn-small  " href="<?php echo base_url().'loket/sosial_pendidikan/add' ;?>">Tambah Pendidikan</a></td>
