...
<div id="real">
    ...
    <?php foreach($registrasi->result() as $anggota):?>
        <?php echo form_open('loket/admission_registrasi/edit'); ?>
        ...
        <tr>
                ...
                <tr>
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td><input type="submit" value="Update" class="btn btn-small"> <input type="submit"  value="Batal"  class="btn btn-small"></td>
                    </tr>
            </tbody>
	</table>
    <?php echo form_close();?>
