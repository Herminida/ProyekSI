        ...
        <title></title>
            ...
            $(document).ready(function(){
               ...
               $("#update").live("click",function(){
                     ...
                     var id_pasien_rawat_inap = $("#id_pasien_rawat_inap").val();
                     ...
                     $.ajax({
                            type:"POST",
                            url :"<?php echo base_url();?>loket/list_pasien_rawat_inap/update",
                            data:"id_pasien_rawat_inap="+id_pasien_rawat_inap+"&nama_penanggung_jawab="+nama_penanggung_jawab+"&no_penanggung_jawab="+no_penanggung_jawab+"&hubungan_dengan_pasien="+hubungan_dengan_pasien,
...
<div id="real">
  <div id="statusdonor">
    ...
    <table class="table table-striped">
            ...
            <tr>
                <td width="90%"><b>::. EDIT DATA PASIEN RAWAT INAP</b></td>
        ...
        <table class="table table-striped">
        	<tbody>
        		...
        		<tr>
        			...
        			<td>:</td>
        			<td>
                       <input type="text" name="nama_kelas_kamar" readonly="true" id="nama_kelas_kamar" value=" <?php echo $nama_kelas_kamar ?>">
                    </td>
        		</tr>
                <tr>
                    <td>Ruang Kamar</td>
                    <td>:</td>
                    <td>
                       <input type="text" name="nama_ruang_kamar" readonly="true" id="nama_ruang_kamar" value=" <?php echo $nama_ruang_kamar ?>">
                    </td>
                </tr>

                <input type="hidden" name="id_pasien_rawat_inap" id="id_pasien_rawat_inap" value="<?php echo $id_pasien_rawat_inap?>">
