...
<?php
	if(isset($pencarian)){
		?>
		<div style="float:right;"><a href="<?php echo base_url()?>loket/laporan_loket/laporan_pasien_rekanan_excel/<?php echo $pencarian;?>"><button class="btn"><i class="icon icon-file"></i> Export</button></a> || <button class="btn" id="btn-print"> <i class="icon icon-print"></i> Cetak</button></div>
		<?php
	}
	else{
		?>
...
<table class="table table-bordered " border="1" style="height:30px">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo $tampil['nama_rekanan'];?></td>
		</tr>
		<?php
			}
		?>
