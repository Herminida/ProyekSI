...
function edit(){
    if(diData){
    $('#frmDiagnosa input[name="id_gaji_jabatan"]').val(diData.id_gaji_jabatan);
...
$(document).ready(function(){  
  ...
  function hapus(){
    var gaji_pegawai  =  diData.id_gaji_jabatan;
    var data={
                id_gaji_jabatan:gaji_pegawai,
            };
      $.ajax({
        ...
        alert("Nilai Gaji Masih Kosong");
         $("#nilai_gaji").focus();
          ...
          data={
                ...
                id_gaji_jabatan:$('#frmDiagnosa input[name="id_gaji_jabatan"]').val(),
                gaji_id:gaji_id,
...
<div class="span10">
  <br/>
    ...
    <input type="hidden" name="id_gaji_jabatan" id="id_gaji_jabatan" value=''>
		<table>
			<tr>
