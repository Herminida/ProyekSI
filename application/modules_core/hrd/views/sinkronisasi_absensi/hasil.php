<div style="float:left;"><a href="<?php echo base_url()?>hrd/sinkronisasi_absensi/export/<?php echo $pencarian;?>"><button class="btn"><i class="icon icon-file"></i> Export</button></a> || <button class="btn" id="btn-print"> <i class="icon icon-print"></i> Cetak</button></div>
<br><br>
