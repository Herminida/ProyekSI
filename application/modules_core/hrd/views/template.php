                ...
                <div class="navbar navbar-fixed-top">
                    <div class="navbar-inner">
                        <div class="container-fluid">
                            <a class="brand" href="<?php echo base_url();?>loket"><i class="icon-home icon-white"></i> HRD RS JEMBER</a>
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      <a href="#collapseOne" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
                        <i class="icon-folder-close"></i> Biodata Pegawai
                      </a>
                    </div>
                    <div class="accordion-body collapse" id="collapseOne">
                      <div class="accordion-inner">
                        <ul class="nav nav-list">
                         ...
                         -->
                         <li><?php echo anchor('hrd/admission_klinik','Master Unit Kerja',(($this->uri->segment(2)=='admission_klinik')?'class="text-error"':''));?></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                   <div class="accordion-group">
                    <div class="accordion-heading">
                      <a href="#collapsetwo" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
                        <i class="icon-folder-close"></i> Kesejahteraaan Pegawai
                      </a>
                    </div>
                    <div class="accordion-body collapse" id="collapsetwo">
                      <div class="accordion-inner">
                        <ul class="nav nav-list">
                          <li><?php echo anchor('hrd/tunjangan','Master Tunjangan',(($this->uri->segment(2)=='tunjangan')?'class="text-error"':''));?></li>
                          <li><?php echo anchor('hrd/tunjangan_pegawai','Tunjangan Pegawai',(($this->uri->segment(2)=='tunjangan_pegawai')?'class="text-error"':''));?></li>
                          <li><?php echo anchor('hrd/gaji','Master Gaji',(($this->uri->segment(2)=='gaji')?'class="text-error"':''));?></li>
                          <li><?php echo anchor('hrd/gaji_jabatan','Standar Gaji Per Jabatan',(($this->uri->segment(2)=='gaji_jabatan')?'class="text-error"':''));?></li>
                          <li><?php echo anchor('hrd/gaji_pegawai','Gaji Pegawai',(($this->uri->segment(2)=='gaji_pegawai')?'class="text-error"':''));?></li>
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      <a href="#collapsetree" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
                        <i class="icon-folder-close"></i> Jam Kerja
                      </a>
                    </div>
                    <div class="accordion-body collapse" id="collapsetree">
                      <div class="accordion-inner">
                        <ul class="nav nav-list">
                          <li><a href="<?php echo base_url();?>hrd/shift">Master Shift</a></li>    
                          <li><a href="<?php echo base_url();?>hrd/jam_kerja">Set Jam Kerja</a></li>    
                          <li><a href="<?php echo base_url();?>hrd/jam_kerja_pegawai">Jam Kerja Pegawai</a></li>    
                          <li><a href="<?php echo base_url();?>hrd/absensi">Absensi Pegawai</a></li>    
                          <li><a href="<?php echo base_url();?>hrd/sinkronisasi_absensi">Sinkronisasi Absensi Pegawai</a></li>    
                          <li><a href="<?php echo base_url();?>hrd/surat_ijin">Cetak Surat Ijin</a></li>    
                        </ul>
                      </div>
                    </div>
                  </div>
