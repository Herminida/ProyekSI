        ...
        <title></title>
            ...
            $(document).ready(function(){
                ...
                $("#update").live('click',function(){
                    ...
                    $.ajax({
                            type:"POST",
                            url :"<?php echo base_url();?>hrd/gaji/edit",
                            data:"id="+id+"&nama_gaji="+nama_gaji,
        ...
        <table class="table table-striped">
        	<tbody>
        		...
        		<tr>
        			...
        			<td>:</td>
        			<td>
                        <input type="text" name="nama_gaji" id="nama_gaji" value="<?php echo $nama_gaji ?>"> 
                    </td>
                     <td>&nbsp;</td>
        		</tr>

            <input type="hidden" name="id" id="id" value="<?php echo $id_gaji ?>" >
