<?php
	class absensi_model Extends Ci_model{
		...
		function getData(){
			...
			return $this->db->query("select a.*,b.nama_pegawai from tbl_absensi a join pegawai b on a.nip_pegawai=b.nip_pegawai where tanggal_absensi='$tanggal_sekarang' order by id_absensi DESC limit 20 ");
		}
	}
?>