        ...
        <title></title>
            ...
            $(document).ready(function(){
                $("#update").live('click',function(){
                    ...
                    $.ajax({
                            type:"POST",
                            url :"<?php echo base_url();?>hrd/shift/edit",
                            data:"id_shift="+id+"&nama_shift="+nama_shift,
    ...
    <table class="table table-striped">
       	<tbody>
      		<tr>
        			...
        			<td>:</td>
        			<td>
                        <input type="text" name="nama_shift" id="nama_shift" value="<?php echo $nama_shift ?>"> 
              </td>
              <td>&nbsp;</td>
      		</tr>
            <input type="hidden" name="id_shift" id="id" value="<?php echo $id_shift ?>" >
          <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td colspan="1"> 
