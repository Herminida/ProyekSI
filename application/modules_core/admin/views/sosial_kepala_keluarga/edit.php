...
<div id="real">
    ...
    <div id="statusdonor">
        ...
        <?php echo form_open('loket/sosial_kepala_keluarga/edit'); ?>
            <table class="table table-striped">

                <thead>
            <tr>
                <th colspan="6">::. Edit Kepala Keluarga</th>
            </tr>
            </thead>
            ...
            <tbody>
                ...
                <td>No KK</td>
                <td>:</td>
                <td><input type="text" name="no_kk" value="<?php echo $no_kk ?>" placeholder="Masukkan No KK" ></td>
                ...
                <td>Nama KK</td>
                <td>:</td>
                <td><input type="text" name="nama_kk" value="<?php echo $nama_kk ?>" placeholder="Masukkan Nama KK" ></td>
                ...
                <td>Alamat KK</td>
                <td>:</td>
                <td><input type="text" name="alamat" value="<?php echo $alamat ?>" placeholder="Masukkan Alamat KK" ></td>
                ...
                <td>RT/RW</td>
                <td>:</td>
                <td><input type="text" name="rt" value="<?php echo $rt ?>" placeholder="RT" style="width:25%;">
                    <input type="text" name="rw" value="<?php echo $rw ?>" placeholder="RW" style="width:25%;">
                </td>
                   ...
                   <select name="kecamatan_id" id="kecamatan_id" style="width:205px;">
                        ...
                        <?php 
                            foreach ($kecamatan->result_array() as $d) {
                                if ($kecamatan_id == $d['id_kecamatan']) {
                        ?>  
                ...
                <td><select name="kelurahan_id" id="kelurahan_id" style="width: 205px">
                    <option value="">--Pilih Kelurahan--</option>
                        <?php 
                            foreach ($kelurahan->result_array() as $d) {
                                if ($kelurahan_id == $d['id_kelurahan']) {
                        ?>  
                            <option value="<?php echo $d['id_kelurahan']; ?>" selected="selected"><?php echo $d['nama_kelurahan']; ?></option>
                        <?php 
                                }
