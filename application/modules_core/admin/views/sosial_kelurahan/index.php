<div id="real">
    <div id="statusdonor">
        ...
        <table class="table">
            <?php echo form_open('loket/sosial_kelurahan/search','class="navbar-form pull-right" ');?>
            <tr>
                <td width="56%"><a class ="btn btn-small  " href="<?php echo base_url().'loket/sosial_kelurahan/add' ;?>">Tambah Kelurahan</a></td>
           ...
           <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class='btn btn-small  ' href="<?php echo base_url(); ?>loket/sosial_kelurahan/delete/<?php echo $db['id_kelurahan']; ?>" onclick="return confirm('Anda yakin ingin mengahapus kelurahan <?php echo $db['nama_kelurahan'] ?> ?');"><i class="icon-remove"></i></a>
                    </td>
