<div id="real">
  ...
  ?>
    ...
    <td>
      ...
      <a href="<?php echo base_url(); ?>farmasi/apt_supplier/delete/<?php echo $dp['id_supplier']; ?>" class="btn btn-small btn-warning" onClick="return confirm('Anda yakin menghapus data <?php echo $dp['nama_supplier'];?> Karena Akan Mempengaruhi Data Lain???');"><i class="icon-remove"></i></a>
