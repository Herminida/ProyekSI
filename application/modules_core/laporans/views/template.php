    ...
    <div id="leftcontent">
        <div class="sidebar-nav">
          <ul class="nav nav-list">
            <li class="nav-header" data-target="#master" data-toggle="collapse">Laporans</li>
            <div class="collapse" id="master">
               <li><?php echo anchor('/laporans/farmasi_lplpo','Farmasi LPLPO',(($this->uri->segment(2)=='farmasi_lplpo')?'class="text-error"':''));?></li>
              <li><?php echo anchor('/laporans/gudang_lplpo','Gudang LPLPO',(($this->uri->segment(2)=='gudang_lplpo')?'class="text-error"':''));?></li>
              <li><?php echo anchor('/laporans/apotek_lplpo','Apotek LPLPO',(($this->uri->segment(2)=='apotek_lplpo')?'class="text-error"':''));?></li>
              <li><?php echo anchor('/laporans/laporan_lb1','Laporan LB1',(($this->uri->segment(2)=='laporan_lb1')?'class="text-error"':''));?></li>
          ...
          $(function(){
            <?php if(in_array($this->uri->segment(2),array('farmasi_lplpo','gudang_lplpo','apotek_lplpo','laporan_lb1'))){?>
