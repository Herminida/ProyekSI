    ...
    <div id="statusdonor">
		...
		<?php echo form_open('farmasi/farmasi_obats/add'); ?>
            ...
            <tbody>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td> <?php echo form_submit(array('name'=>'simpan','id'=>'simpan','value'=>'Simpan','class'=>'btn btn-mini btn-success'));?>
                    <?php echo form_reset(array('name'=>'batal','id'=>'batal','value'=>'Reset','class'=>'btn btn-mini btn-success'));?>
