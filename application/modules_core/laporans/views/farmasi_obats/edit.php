...
<div id="real">
    <div id="statusdonor">
		...
		<?php echo form_open('farmasi/farmasi_obats/edit'); ?>
			<table class="table table-striped">

				<thead>
            <tr>
                <th colspan="4">::. Edit Obat</th>
            </tr>
            </thead>
            ...
            <tbody>
                ...
                <td>Nama Obat</td>
                <td>:</td>
                <td><input type="text" name="nama_obat" placeholder="Masukkan Nama Obat" value="<?php echo $nama_obat; ?>"></td>
                ...
                <td>Dosis</td>
                <td>:</td>
                <td><input type="text" name="dosis" placeholder="Masukkan Dosis" value="<?php echo $dosis; ?>"></td>
                ...
                <td>Stok</td>
                <td>:</td>
                <td><input type="text" name="qtt" placeholder="Masukkan Stok" value="<?php echo $qtt; ?>"></td>
                ...
                <td>Harga Beli</td>
                <td>:</td>
                <td><input type="text" name="harga_beli" placeholder="Masukkan Harga Beli" value="<?php echo $harga_beli; ?>"></td>
                ...
                <td>Harga Jual</td>
                <td>:</td>
                <td><input type="text" name="harga_jual" placeholder="Masukkan Harga Jual" value="<?php echo $harga_jual; ?>"></td>
                ...
                <td> <?php echo form_submit(array('name'=>'simpan','id'=>'simpan','value'=>'Simpan','class'=>'btn btn-small btn-success'));?>
                    ...
                    <a href="<?php echo base_url();?>farmasi/farmasi_obats/index" class="btn btn-mini btn-success">Batal</a>
                </td>
                <td>&nbsp;</td>
            </tr>
