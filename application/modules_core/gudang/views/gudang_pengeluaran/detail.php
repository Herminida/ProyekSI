        ...
        if($detail_gudang_pengeluaran->num_rows()>0)
        {
         ...
         $(\"#simpan".$n."\").click(function() {
              ...
              var id2 = $(\"#id".$n."\").val();
               ...
               $.ajax({
                            type:\"POST\",
                            url :\"".base_url()."gudang/gudang_pengeluaran/updateid\",
...
<body>
  <div id="real">
    <div id="statusdonor">
     ...
     <a href="<?php echo base_url();?>gudang/gudang_pengeluaran/add/<?php echo $h['id'];?>" class="btn btn-small">Tambah Gudang Pengeluaran</a>
     <br><br>
...
<table class="table table-striped">
        ...
        <tr>
          ...
          <td><a class="btn btn-small" ><i class="icon icon-wrench" id="edit<?php echo $no ; ?>"></i></a>
            ...
            <a href="<?php echo base_url();?>gudang/gudang_pengeluaran/delete_item/<?php echo $data['keluar_id'];?>/<?php echo $data['id'];?>" class="btn btn-small" onclick="return confirm('Apakah Anda Yakin Ingin Mengahapus <?php echo $data['nama_obat']; ?> ?')" id="delete<?php echo $no ; ?>"><i class="icon icon-remove"></i></a>
          </td>
      ...
      <a href="<?php echo base_url();?>gudang/gudang_pengeluaran" class="btn btn-small">Kembali</a>
      <a href="<?php echo base_url();?>gudang/gudang_pengeluaran/view/" class="btn btn-small">List Pengeluaran</a>
      <a class="btn btn-small" onclick="javascript:window.open('<?php echo base_url()?>gudang/gudang_pengeluaran/cetak/<?php echo $h['id']; ?>','mywin','left=20,top=10,width=590,height=600,toolbar=0,resizable=0')"><i class="icon icon-print"></i> Cetak</a>
