    ...
    <script>
          ...
          count += 1;
            ...
            $("#jumlah_"+count).live('click',function(){ //pembuka validasi obat
              var obat=$("#obat_id_"+count).val();
                        $.ajax({
                            type:"POST",
                            url :"<?php echo base_url();?>gudang/gudang_pengeluaran/falidasiobat",
                            data: "obat="+obat ,
            ...
            $("#simpan").live('click',function() {           
                var obat=$("#obat_id_"+count).val();
                        $.ajax({
                            type:"POST",
                            url :"<?php echo base_url();?>gudang/gudang_pengeluaran/falidasiobatbatal",
                            data: "obat="+obat ,
                            success : function (data) {
        ...
        $("#jumlah_"+count).live('keyup',function(){
            ...
            var tahun=$('#thn').val();
                        ...
                        $.ajax({
                            type:"POST",
                            url :"<?php echo base_url();?>gudang/gudang_pengeluaran/falidasijumlahobat",
            ...
            $("#obat_id_"+count).live('focus',function(){ // pembuka auto complate
               $("#obat_id_"+count).autocomplete({
                ...
                function(req, add){
                    $.ajax({
                        url: "<?php echo base_url(); ?>gudang/gudang_pengeluaran/lookup",
                        dataType: 'json',
                        type: 'POST',
                        data: req,
                        success:    
  ...
  <div id="real">
    ...
    ?>
    <?php echo form_open('gudang/gudang_pengeluaran/save'); ?>
