  <div id="real">
    ...
    <table class="table">
      <?php echo form_open("gudang/gudang_pengeluaran/search",'class="navbar-form pull-right"'); ?>
      <tr>
        <td>
            <?php
      ...
      <table class="table">
        ...
        ?>
          ...
          <tbody>
            <tr>
                <td colspan="2"><a class="btn btn-small" href="<?php echo base_url()?>gudang/gudang_pengeluaran/detail/<?php echo $data['id']?>">detail</a></td>
                <td>
                  <?php
                    echo $data['no_nota'];
                  ?>
