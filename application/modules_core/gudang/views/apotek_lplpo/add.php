  ...
  <head>
          ...
          count += 1;
            ...
            $("#jumlah_"+count).live('click',function(){ //pembuka validasi obat
              var obat=$("#obat_id_"+count).val();
                        $.ajax({
                            type:"POST",
                            url :"<?php base_url();?>apotek_penerimaan/falidasiobat",
                            data: "obat="+obat ,
        ...
        $("#jumlah_"+count).live('keyup',function(){
            ...
            $("#obat_id_"+count).live('focus',function(){ // pembuka auto complate
               $("#obat_id_"+count).autocomplete({
                ...
                function(req, add){
                    $.ajax({
                        url: "<?php echo base_url(); ?>index.php/apotek_penerimaan/lookup",
                        dataType: 'json',
                        type: 'POST',
                        data: req,
                        success:    
    ...
    $(".btn2").live('click',function() {
                ...
                var obat=$("#obat_id_"+nomor).val();
                        $.ajax({
                            type:"POST",
                            url :"<?php base_url();?>apotek_penerimaan/falidasiobatbatal",
                            data: "obat="+obat ,
                            success : function (data) {
                                $("#tampilkandata").html(data);
                            }
...
<body>
  <div id="real">
    <div id="statusdonor">
      <?php echo form_open('apotek_penerimaan/save_add');?>
