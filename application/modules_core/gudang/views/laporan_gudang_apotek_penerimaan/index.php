...
<body>
    <div id="real">
        <div id="statusdonor">
            <?php echo form_open('gudang/laporan_gudang_apotek_penerimaan/tampil');?>
            <input type="hidden"  name="tujuan"  value="<?php echo $this->session->userdata("id_unit_kerja"); ?>">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th colspan="5">::.Laporan Gudang Apotek Penerimaan</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width:250px;" name="" readonly="readonly" value="<?php echo $tm['nama_unit_kerja']; ?>"></td>
                        <?php
                            }
                            ?>
            ...
            <input type="hidden" name="unit_kerja_id"  value="<?php echo $tm['id_unit_kerja']; ?>"></p>
