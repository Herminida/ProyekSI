...
<head>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      <?php 
        $n = 1;
        if($detail_apotek_penerimaan->num_rows()>0)
        {
          foreach($detail_apotek_penerimaan->result_array() as $data)
          {
         ...
         $(\"#simpan".$n."\").click(function() {
              ...
              var id2 = $(\"#id".$n."\").val();
               ...
               $.ajax({
                            type:\"POST\",
                            url :\"".base_url()."apotek_penerimaan/updateid\",
...
<body>
  <div id="real">
    <div id="statusdonor">
      <?php foreach ($apotek_penerimaan_header->result_array() as $data) { ?>
     ...
     <a href="<?php echo base_url();?>apotek_penerimaan/add/<?php echo $data['id'];?>" class="btn btn-small btn-success">Tambah Apotek Penerimaan</a>
     <br><br>
...
<table class="table table-striped">
        ...
        <tr>
          ...
          <td><a class="btn btn-small btn-success" ><i class="icon icon-wrench" id="edit<?php echo $no ; ?>"></i></a>
            ...
            <a href="<?php echo base_url();?>farmasi_penerimaan/delete_item/<?php echo $data['terima_id'];?>/<?php echo $data['id'];?>" class="btn btn-small btn-warning" onclick="return confirm('Apakah Anda Yakin Ingin Mengahapus <?php echo $data['nama_obat']; ?> ?')" id="delete<?php echo $no ; ?>"><i class="icon icon-remove icon-white"></i></a>
          </td>
      ...
      <a href="<?php echo base_url();?>apotek_penerimaan" class="btn btn-mini btn-success">Kembali</a>
      <a href="<?php echo base_url();?>apotek_penerimaan/view/" class="btn btn-mini btn-success">List Penerimaan</a>
