...
public function save_add () {
    ...
    redirect('gudang/gudang_penerimaan/detail2/'.$keluar_id_insert);
...
public function delete_item() {
    ...
    redirect('gudang/gudang_penerimaan/detail2/'.$this->uri->segment(4),'refresh');
...
public function updateid () {
    ...
    $up['jumlah_farmasi']=$this->input->post('jumlahr');
...
/*public function cobak() {
    ...
    $query =$this->db->query("select * from gudang_obats where id='$id2' ");
    foreach ($query->result_array() as $key) {
        $up3a = $key['qtt'];
    }
    ...
    $queryobat2 = $this->db->query ("update gudang_obats set qtt  = '$total2' WHERE id='$id2' ");
           
    echo  $queryobat;
    echo  $queryobat2;

    //$this->gudang_penerimaan_model->update_jumlah_stok("farmasi_obats",$up2,$id2);
...
public function cek_list() {
    ...
    $ambildata = $this->gudang_penerimaan_model->updateceklist($idss);
    $this->session->set_flashdata('message','Data Berhasil Di Ceklist');
    redirect('gudang/gudang_penerimaan/view_penerimaan');
