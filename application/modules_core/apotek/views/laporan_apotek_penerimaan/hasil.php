<div class="preview-frame">
    <a href="<?php echo base_url();?>apotek/laporan_apotek_penerimaan/excel" ><img src="<?php echo base_url();?>images/export-icon.gif"></a>
...
<!--            <td width="200" bgcolor="#CCCCCC"><div align="center"><strong>Tgl</strong></div></td>-->
        ...
        <?php 
        $i=1; 
        if($list_apotek_penerimaan->num_rows()>0) {
        foreach ($list_apotek_penerimaan->result_array() as $tampil) { ?>
