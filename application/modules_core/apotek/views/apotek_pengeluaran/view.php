  <div id="real">
    <div id="statusdonor">
       <div><b>::. LIST FARMASI PENGELUARAN OBAT </b> 
      <b style="float:right; margin-right:130px; color:red;"><?php echo validation_errors(); ?></b>
    </div>
    <table class="table">
      <?php echo form_open("farmasi/farmasi_pengeluaran/search",'class="navbar-form pull-right"'); ?>
      <tr>
        <td>
            <?php
      ...
      <table class="table">
          ...
          <thead>
            <tr>
              <th colspan="2">Aksi</th><th>No Nota</th><th>Tujuan</th><th>Tanggal Keluar</th>
            </tr>
          </thead>
          ...
          <tbody>
            <tr>
                <td colspan="2"><a class="btn btn-small" href="<?php echo base_url()?>farmasi/farmasi_pengeluaran/detail/<?php echo $data['id']?>">detail</a></td>
                <td>
                  <?php
                    echo $data['no_nota'];
                  ?>
