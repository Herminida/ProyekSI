    ...
    <table class="table">
      ...
      <table class="table">
        ...
        { foreach ($cari->result_array() as $data) { ?>
          ...
          <tbody>
            <tr>
                <td colspan="2"><a class="btn btn-small" href="<?php echo base_url()?>apotek/apotek_pengeluaran/detail/<?php echo $data['idpemeriksaan']?>">detail</a></td>
                <td>
                  <?php
                    echo $data['no_resep'];
                  ?>
        ...
        <tr style="text-align:center;">
          <td colspan="9">Tidak Ada Pemeriksaan Di Tanggal Yang Anda Maksud</td>
        </tr>
          <?php
        }
      ?>
