  <div id="real">
    ...
    <table class="table">
      <?php echo form_open("apotek/apotek_penerimaan/search",'class="navbar-form pull-right"'); ?>
      <tr>
        <td>
            <?php
      ...
      <table class="table">
          ...
          <?php 
          if($apotek_penerimaan_header2->num_rows()>0)
        {
          foreach ($apotek_penerimaan_header2->result_array() as $data) { ?>
   
          <tbody>
            <tr>
                <td colspan="2"><a class="btn btn-small" href="<?php echo base_url()?>apotek/apotek_penerimaan/detail2/<?php echo $data['id']?>">detail</a></td>
                <td>
                  <?php
                    echo $data['no_nota'];
                  ?>
