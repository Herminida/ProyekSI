...
class laporan_lb1 extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('laporan_lb1_model');
...
//        error_reporting(E_ALL ^ (E_NOTICE));
    ...
    public function exportLb1Print () {
//        error_reporting(E_ALL ^ (E_NOTICE));
        if($this->input->post('tanggal_laporan1')==''){
            $tanggal1=$this->input->post('tanggallaporan1');
            $tanggal2=$this->input->post('tanggallaporan2');
        ...
        $this->load->view('laporan_lb/cetaklb1',$data);
    }
