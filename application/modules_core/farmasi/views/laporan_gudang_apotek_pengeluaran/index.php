...
<body>
    <div id="real">
        <div id="statusdonor">
            <?php echo form_open('farmasi/laporan_gudang_apotek_pengeluaran/tampil');?>
            <input type="hidden"  name="unit_kerja_id"  value="<?php echo $this->session->userdata("id_unit_kerja"); ?>">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th colspan="5">::.Laporan Gudang Apotek Pengeluaran</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select style="width:250px; height:25px; font-size:12px;" name="tujuan">
