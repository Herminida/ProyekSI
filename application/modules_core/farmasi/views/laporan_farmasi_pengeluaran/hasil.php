<div class="preview-frame">
    <a href="<?php echo base_url();?>farmasi/laporan_farmasi_pengeluaran/excel" ><img src="<?php echo base_url();?>images/export-icon.gif"></a>
...
<!--            <td width="200" bgcolor="#CCCCCC"><div align="center"><strong>Tgl</strong></div></td>-->
        ...
        <?php 
        $i=1; 
        if($list_farmasi_pengeluaran->num_rows()>0) {
        foreach ($list_farmasi_pengeluaran->result_array() as $tampil) { ?>
