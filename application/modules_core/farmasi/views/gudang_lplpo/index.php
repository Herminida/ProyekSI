...
<div id="real">
    <div id="statusdonor">
        <?php echo form_open('laporans/gudang_lplpo');?>
        ...
        <?php echo form_open('laporans/gudang_lplpo/generateLplpo');?>
        <table class="table table-striped">
        ...
        <?php echo form_open('laporans/gudang_lplpo/exportLplpoXls',array('target'=>'blank'));?>
            <input type="hidden" name="tanggal_generate" value="<?php echo $tanggalgenerate;?>"/>
