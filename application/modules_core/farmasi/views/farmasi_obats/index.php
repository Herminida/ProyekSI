  ...
  <div id="real">
    <div id="statusdonor">
      ...
      <table class="table">
        ...
        <tr>
          <td width="80%"><a href="<?php echo base_url();?>farmasi/farmasi_obats/add" class="btn btn-small">Tambah Obat</a></td>
        ...
        <tbody>
          ...
          $no=1; 
            ...
            <tr>
              <td><?php echo $no ?></td>
              <td colspan="2">
                <a href="<?php echo base_url();?>farmasi/farmasi_obats/edit/<?php echo $data['id']; ?>" class="btn btn-small" ><i class="icon-wrench"></i></a>
                <a href="<?php echo base_url();?>farmasi/farmasi_obats/delete/<?php echo $data['id']; ?>" class="btn btn-small" onclick="return confirm('Apakah Anda Yakin Ingin Mengahapus <?php echo $data['nama_obat']; ?> ?')" ><i class="icon-remove"></i></a>
