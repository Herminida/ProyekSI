...
<div class="span10">
  <br/>
    ...
    <input type="hidden" name="id_penerimaan_obat_supplier" id="id_penerimaan_obat_supplier" value=''>
		<table>
			<tr>
...
function reset(){
  ...
  //start hapus
   data={ idTunjanganPegawai:diData.id_penerimaan_obat_supplier};
     $.ajax({
            url: "<?php echo site_url('farmasi/'.'penerimaan_obat_supplier/deleteTunjanganPegawai')?>",
            data: data,
            method:'post',
            dataType: 'json',
...
function edit(){
    if(diData){
    reset();
    $('#frmDiagnosa input[name="id_penerimaan_obat_supplier"]').val(diData.id_penerimaan_obat_supplier);
    $('#frmDiagnosa input[name="tunjangan_id"]').val(diData.tunjangan_id);
...
$(document).ready(function(){  
  ...
  oTable=$('#tblDiagnosa').dataTable({
      ...
      "bScrollCollapse": false, 
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo site_url('farmasi/'.'penerimaan_obat_supplier/ajaxListTunjanganPegawai')?>"+'/'+pegawai_id,
        "aoColumns": [
    ...
    jTable=$('#tblListICD').dataTable({
      ...
      //"sScrollY":"200px",
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo site_url('farmasi/'.'penerimaan_obat_supplier/ajaxListTunjangan')?>",
        "aoColumns": [
            { "mData": "nama_tunjangan" }
        ...
        alert("Nilai Tunjangan Masih Kosong");
         $("#nilai_tunjangan").focus();
          ...
          data={
                ...
                id_penerimaan_obat_supplier:$('#frmDiagnosa input[name="id_penerimaan_obat_supplier"]').val(),
          ...
          $.ajax({
            ...
            url: "<?php echo site_url('farmasi/'.'penerimaan_obat_supplier/simpanTunjangan')?>",
            data: data,
            method:'post',
            dataType: 'json',
...
{    $.ajax({
            type:"POST",
                url :"<?php echo base_url();?>farmasi/penerimaan_obat_supplier/cek",
