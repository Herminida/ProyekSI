...
<div id="real">
    <div id="statusdonor">
        <?php echo form_open('laporans/apotek_lplpo');?>
        <table class="table table-striped">
            <thead><tr><th colspan="3">::. Laporan LPLPO (LB2)</th></tr></thead>
            <tbody>
                <tr><td>Periode</td><td><?php echo $bulan_laporan.' '.$tahun_laporan;?> <input type="submit" value="Buat Laporan" class="btn-small btn-success"></td></tr>
            </tbody>
        </table>
        <?php echo form_close();?>
        
        <?php echo form_open('laporans/apotek_lplpo/generateLplpo');?>
        <table class="table table-striped">
        ...
        <input type="submit" value="Generate" class="btn-small btn-success">
        <?php echo form_close();?>
        
        <?php echo form_open('laporans/apotek_lplpo/exportLplpoXls',array('target'=>'blank'));?>
            <input type="hidden" name="tanggal_generate" value="<?php echo $tanggalgenerate;?>"/>
            <?php echo $bulan_laporan.' '.$tahun_laporan;?>       
