...
<body>
  <div class="well-big">
    <?php echo form_open('farmasi_pengeluaran'); ?>
  	<legend>Laporan Mutasi Pengeluaran  <div align="right"><input type="submit" class="btn btn-success" name="add_btn" value="Kembali" ></div></legend>
    <?php echo form_close(); ?>
  ...
  <?php
    $no=$tot+1;
    $no2=1;
    foreach($data_pengeluaran_mutasi->result_array() as $dp)
    {
  ?>
      <tr>
