        ...
        $("#jumlah_"+count).live('keyup',function(){
            ...
            $("#obat_id_"+count).live('focus',function(){ // pembuka auto complate
               $("#obat_id_"+count).autocomplete({
                ...
                function(req, add){
                    $.ajax({
                        url: "<?php echo base_url(); ?>index.php/farmasi_penerimaan/lookup",
                        dataType: 'json',
                        type: 'POST',
                        data: req,
                        success:    
          ...
          $('#container').append( //pembuka pembuatan konten
             ...
             + '<td><a class="btn2" nomor="'+count+'" id="remove_item" href="#" ><i class="icon-remove icon-white"></i>Delete</a>'
...
<body>
  <div id="real">
    ...
    <?php echo form_open('farmasi_penerimaan/save_edit'); ?>
  ...
  <table class="table table-striped">
        ...
        <?php
            ...
            <tr>
              ...
              <td>
              	 <a href="<?php echo base_url();?>farmasi_penerimaan/delete_item/<?php echo $data['terima_id']; ?>/<?php echo $data['id']; ?>" class="btn btn-small btn-warning" onclick="return confirm('Apakah Anda Yakin Ingin Mengahapus <?php echo $data['nama_obat']; ?> ?')" >Hapus</a>
...
<table width="100%">
<input type="button" class="btn btn-success btn-small" name="add_btn" value="Tambah Obat" id="add_btn">
&nbsp;
<input type="submit" name=submit id="simpan" class="btn btn-success btn-small" value="Simpan">
