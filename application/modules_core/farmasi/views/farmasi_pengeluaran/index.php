    ...
    function load() {
                        ...
                        $.ajax({
                            type:"POST",
                            url :"<?php echo base_url();?>farmasi/farmasi_pengeluaran/falidasiobatbataloke",
...
<body onload="load()">
  <div id="real">
    ...
    ?>
    <?php echo form_open('farmasi/farmasi_pengeluaran/save'); ?>
    <table class="table table-striped">

        <thead>
            <tr>
                <th colspan="6">::. Farmasi Pengeluaran</th>
            </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td id="pesannota" style="width:30%; color:red;" ></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>:</td>
            <td>
              <select style="width:250px; height:25px; font-size:12px;" name="tujuan" id="unit_kerja">
        <option value="">== Pilih Unit Kerja==</option>

        <?php
          foreach ($nama_unit_kerja->result_array() as  $value) {
