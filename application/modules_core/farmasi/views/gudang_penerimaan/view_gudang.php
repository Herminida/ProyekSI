  <div id="real">
    ...
    <table class="table">
      <?php echo form_open("farmasi/gudang_penerimaan/search",'class="navbar-form pull-right"'); ?>
      <tr>
        <td>
            <?php
      ...
      <table class="table">
          ...
          if($gudang_penerimaan_header2->num_rows()>0)
        {
          ...
          <tbody>
            <tr>
                <td colspan="2"><a class="btn btn-small" href="<?php echo base_url()?>farmasi/gudang_penerimaan/detail2/<?php echo $data['id']?>">detail</a></td>
                <td>
                  <?php
                    echo $data['no_nota'];
                  ?>
