  <div id="real">
    ...
    <table class="table">
      <?php echo form_open("gudang_penerimaan/search",'class="navbar-form pull-right"'); ?>
      <tr>
        <td>
            <?php
      ...
      <table class="table">
          ...
          <thead>
            <tr>
              <th colspan="2">Aksi</th><th>No Nota</th><th>Tujuan</th><th>Tanggal Terima</th><th>Nama Sumber</th><th>Suplier</th>
            </tr>
          </thead>
          ...
          <tbody>
            <tr>
                <td colspan="2"><a class="btn btn-mini btn-success" href="<?php echo base_url()?>gudang_penerimaan/detail/<?php echo $data['id']?>">detail</a></td>
                <td>
                  <?php
                    echo $data['no_nota'];
                  ?>
