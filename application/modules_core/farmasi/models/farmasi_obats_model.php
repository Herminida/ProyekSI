...
class Farmasi_obats_model extends CI_Model {
	...
	public function Ambil_ID_Obats($obat_id) {
		return $this->db->query("select id,qtt,nama_obat from farmasi_obats where nama_obat='$obat_id'");
	}
	...
	public function Update_Obats1($nama_obat) {
	...
	public function Update_Batal1($nama_obat) {

		$this->db->query ("update farmasi_obats  SET  aksi = 'belum' where nama_obat ='$nama_obat' ");
	}

	public function Update_Bataloke($batal) {

		$this->db->query ("update farmasi_obats  SET  aksi = '$batal'  ");
	}
}