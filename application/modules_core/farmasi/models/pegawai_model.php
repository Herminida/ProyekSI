...
class pegawai_model extends CI_Model {
	...
	function Ambil_Data_Pegawai3 ($id_pegawai) {

			return $this->db->query("select a.*,DATE_FORMAT(a.tgl_lahir,'%d %b %Y') as tanggal,DATE_FORMAT(a.tgl_lahir,'%Y') as thn,DATE_FORMAT(a.tgl_lahir,'%m') as bln,DATE_FORMAT(a.tgl_lahir,'%d') as tgl,b.id_jabatan as id_jabatan,b.nama_jabatan as nama_jabatan,c.nama_agama as nama_agama from pegawai a
				join jabatan b on a.fk_jabatan=b.id_jabatan join sosial_agama c on a.agama_id=c.id
				where a.id_pegawai='$id_pegawai' ");
