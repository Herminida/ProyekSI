 ...
 <!--/span9-->
   ...
   function hapus(){
    ...
    data={ id_dokter:dokterData.nik_dokter};
     $.ajax({
            url: "<?php echo site_url('master/dokter/hapusdokter')?>",
            data: data,
            method:'post',
            dataType: 'json',
...
dokterData='';
  ...
  jQuery(document).ready(function(){
      ...
      "bScrollCollapse": false, 
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo site_url('master/dokter/getListDokter')?>",
        "aoColumns": [
              { "mData": "nik_dokter" }
             ,{ "mData": "nama_dokter" }
             ,{ "mData": "telp_dokter" }
      ...
      $('#frmDokter').submit(function(){
        ...
        if(err){
          ...
          $.ajax({
            url: '<?php echo site_url('master/dokter/simpanDokter')?>',
            data: data,
            method:'post',
            dataType: 'json',
            success: function(obj){
