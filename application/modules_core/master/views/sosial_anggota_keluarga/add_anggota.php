...
<div id="real">
  <div id="statusdonor">
    <?php echo form_open('loket/sosial_anggota_keluarga/add_anggota','class="form-horizontal"'); ?>

    <?php
        foreach($kk_id->result_array() as $d) {
            echo "<input type=hidden
            value='$d[id]' name='kk_id'/>";
        ...
        ?>
                                    ...
                                    <?php
        foreach($kk_id->result_array() as $d) {
            echo "<input type=hidden value='$d[no_kk]' name=no_kk />";
        ...
        ?>
                                     ...
                                     <?php
        foreach($kk_id->result_array() as $d) {
            echo "<input type=hidden value='$d[nama_kk]' name=nama_kk />";
         ...
         <table class="table table-striped">
          ...
          <tbody>
            <tr>
                ...
                <td style="width:45%; color:red;"><?php echo form_error('nik'); ?> </td>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td>Puskesmas</td>
                <td>:</td>
                <td><input type="text" name="puskesmas_id" placeholder="Masukkan Puskesmas" ></td>
                <td style="width:30%; color:red;"><?php echo form_error('puskesmas_id'); ?> </td>
                <td>&nbsp;</td>
            </tr>
