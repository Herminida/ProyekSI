<div id="real">
	<div id="statusdonor">
		...
		<table class="table">
			<?php echo form_open('master/sosial_pekerjaan/search','class="navbar-form pull-right" ');?>
			<tr>
				<td width="58%"><a class ="btn btn-small  " href="<?php echo base_url().'master/sosial_pekerjaan/add' ;?>">Tambah Pekerjaan</a></td>
