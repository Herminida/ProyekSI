...
<div id="real">
    <div id="statusdonor">
		...
		<?php echo form_open('master/sosial_pekerjaan/add'); ?>
			<table class="table table-striped">

				<thead>
            <tr>
                <th colspan="4">::. Input Pekerjaan</th>
            </tr>
            </thead>
            ...
            <tbody>
                ...
                <td>Pekerjaan</td>
                <td>:</td>
                <td><input type="text" name="nama_pekerjaan" placeholder="Masukkan Pekerjaan"></td>
                ...
                <td colspan="2"> <?php echo form_button(array('type'=>'submit','content'=>'Simpan','name'=>'simpan','id'=>'simpan','value'=>'Simpan','class'=>'btn btn-small  '));?>
                    ...
                    <a href="<?php echo base_url();?>master/sosial_pekerjaan" class="btn btn-small  ">Batal</a>
                </td>
                <td>&nbsp;</td>
            </tr>
