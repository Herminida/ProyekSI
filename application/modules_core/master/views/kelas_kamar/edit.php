...
<div id="real">
    <div id="statusdonor">
      <center><b style="float:center;  color:red;"><?php echo $this->session->flashdata('message'); ?></b></center>
		<?php echo form_open('master/kelas_kamar/edit'); ?>
        <input type="hidden" name="id_kelas_kamar" value="<?php echo $id;?>">
            ...
            <tbody>
                ...
                <td>Kelas Kamar</td>
                <td>:</td>
                <td><input type="text" name="kelas_kamar" placeholder="Masukkan Kelas Kamar" value="<?php echo $nama_kamar;?>"></td>
