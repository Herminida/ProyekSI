<div id="real">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class='btn btn-small  ' href="<?php echo base_url(); ?>master/sosial_kelurahan/delete/<?php echo $db['id_kelurahan']; ?>" onclick="return confirm('Anda yakin ingin mengahapus <?php echo $db['nama_kelurahan'] ?> ?');"><i class="icon-remove"></i></a>
    ...
    <a href="<?php echo base_url();?>master/sosial_kelurahan" class="btn btn-small  ">Kembali</a>
